...
launchButton.onclick = function(event) {
    console.log('Only thing is ... only one onclick event per element...');
}
//  C- element.addEventListener('click', callback)
launchButton.addEventListener('click', function(event){
    console.log('We can attach as many Event Listeners as we want!!');
    console.log(`event type: ${event.type}, event target: ${event.target.nodeName}`)
})
